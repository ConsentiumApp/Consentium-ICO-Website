...
<div id="header">
  <div class="container"> <span class="logo"><a href="#home">
    ...
    <nav> 
      ...
      <a href="#team" id="teamToggle">团队</a> 
...
<section id="home">
  ...
  <div class="content">
    ...
    <br>
    <br>
    <a href="https://drive.google.com/open?id=1sm4kUqHM0ePRWjCUf2ocEPtKEE4cJBIO" target="_blank" class="btn light-btn">阅读白皮书</a>
    <br>
    <br>
    <br>
    <br>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 v-pad" style="text-align:left;">
        ...
        <br>
        <h4>C币将基于以太坊平台。以太坊是全球最大的智能合约区块链。选择以太坊是应因为它能够在速度及代币流通性之间提供平衡。目前，在以太坊运行的货币称为以太。每一个人都可以在代币交易所上使用法定货币购买或销售以太。</h4>
        <br>
        ...
        <ul class="timeline">
          <li class="timeline-item">
            ...
            <div class="timeline-content">
              <h2 class="timeline-title">25/01 - 14/01</h2>
              <h4>私人预售</h4>
            </div>
          </li>
          <li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
              <h2 class="timeline-title">15/03/2018</h2>
              <h4>预售</h4>
            </div>
          </li>
          <li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
              <h2 class="timeline-title">16/03 - 22/03</h2>
              <h4>公开销售</h4>
            </div>
          </li>     
        </ul>
...
<script>
	jQuery(function($){
		...
		$('#new_year').flipcountdown({
			size:'md',
			beforeDateTime:'03/16/2018 00:00:01'
			/*tick:function(){
				var nol = function(h){
					return h>9?h:'0'+h;
				}
